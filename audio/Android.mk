...
#LOCAL_LDFLAGS += -L$(LOCAL_PATH)/../../../../vendor/elephone/p10c/lib/ -laudio.primary.default
LOCAL_SHARED_LIBRARIES := libutils libbinder liblog libcutils libtinyalsa libaudioutils libdl libexpat
